...
clear 
close all
load(['E:\工作\硕士阶段文章\文章\螺旋喇叭\内容提交\上传\fig3\60度斯格名子\60度斯格名子.mat'])
aee=0;
count=0;
...
close all
def=5500+523;
ez_x=draw_z_fix(500:-1:300,def)./em(500:-1:300,def);
[~,aaa]=min(ez_x);
...
S = sample_axisym_from_radial_line(r, erho, etheta, ez, ...
    ...
    'RRange', [0, max(r)], ...
    'Interp', 'pchip', ...
    'AlphaCounts', [50 100 200 400 800 120 10 6 3], ...
